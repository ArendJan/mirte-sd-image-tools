...
source "arm-image" "mirte_orangepizero2" {
  image_type = "armbian"
  iso_url = "https://github.com/ArendJan/mirte_base_images/releases/download/25.5.1/Armbian-unofficial_25.08.0-trunk_Orangepizero2_jammy_edge_6.13.11.img.xz"
  iso_checksum = "file:https://github.com/ArendJan/mirte_base_images/releases/download/25.5.1/Armbian-unofficial_25.08.0-trunk_Orangepizero2_jammy_edge_6.13.11.img.xz.sha"
...
source "arm-image" "mirte_orangepi3b" {
  image_type = "armbian"
  iso_url = "https://github.com/ArendJan/mirte_base_images/releases/download/25.11.2/Armbian-unofficial_25.11.2_Orangepi3b_jammy_edge_6.18.0-rc6.img.xz"
  iso_checksum = "file:https://github.com/ArendJan/mirte_base_images/releases/download/25.11.2/Armbian-unofficial_25.11.2_Orangepi3b_jammy_edge_6.18.0-rc6.img.xz.sha"
